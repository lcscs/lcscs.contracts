...
public:
   ...
   fc::variant get_account( account_name acc, const string& symbolname)
   {
      auto symb = lcscs::chain::symbol::from_string(symbolname);
      auto symbol_code = symb.to_symbol_code().value;
      vector<char> data = get_row_by_account( N(lcscs.token), acc, N(accounts), account_name(symbol_code) );
...
BOOST_FIXTURE_TEST_CASE( retire_tests, lcscs_token_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( open_tests, lcscs_token_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( close_tests, lcscs_token_tester ) try {
