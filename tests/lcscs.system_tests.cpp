...
#include "lcscs.system_tester.hpp"
struct _abi_hash {
   name owner;
   fc::sha256 hash;
};
...
using namespace lcscs_system;

BOOST_AUTO_TEST_SUITE(lcscs_system_tests)
...
BOOST_FIXTURE_TEST_CASE( buysell, lcscs_system_tester ) try {

   BOOST_REQUIRE_EQUAL( core_sym::from_string("0.0000"), get_balance( "alice1111111" ) );

   transfer( "lcscs", "alice1111111", core_sym::from_string("1000.0000"), "lcscs" );
   BOOST_REQUIRE_EQUAL( success(), stake( "lcscs", "alice1111111", core_sym::from_string("200.0000"), core_sym::from_string("100.0000") ) );

   auto total = get_total_stake( "alice1111111" );
   auto init_bytes =  total["ram_bytes"].as_uint64();

   const asset initial_ram_balance = get_balance(N(lcscs.ram));
   const asset initial_ramfee_balance = get_balance(N(lcscs.ramfee));
   ...
   BOOST_REQUIRE_EQUAL( initial_ram_balance + core_sym::from_string("199.0000"), get_balance(N(lcscs.ram)) );
   BOOST_REQUIRE_EQUAL( initial_ramfee_balance + core_sym::from_string("1.0000"), get_balance(N(lcscs.ramfee)) );
   ...
   transfer( "lcscs", "alice1111111", core_sym::from_string("100000000.0000"), "lcscs" );
...
BOOST_FIXTURE_TEST_CASE( stake_unstake, lcscs_system_tester ) try {
   ...
   const auto init_lcscs_stake_balance = get_balance( N(lcscs.stake) );
   ...
   BOOST_REQUIRE_EQUAL( init_lcscs_stake_balance + core_sym::from_string("300.0000"), get_balance( N(lcscs.stake) ) );
   ...
   produce_blocks(1);
   BOOST_REQUIRE_EQUAL( core_sym::from_string("1000.0000"), get_balance( "alice1111111" ) );
   BOOST_REQUIRE_EQUAL( init_lcscs_stake_balance, get_balance( N(lcscs.stake) ) );
...
BOOST_FIXTURE_TEST_CASE( stake_unstake_with_transfer, lcscs_system_tester ) try {
   cross_15_percent_threshold();

   BOOST_REQUIRE_EQUAL( core_sym::from_string("0.0000"), get_balance( "alice1111111" ) );

   //lcscs stakes for alice with transfer flag

   transfer( "lcscs", "bob111111111", core_sym::from_string("1000.0000"), "lcscs" );
   ...
   transfer( "lcscs", "alice1111111", core_sym::from_string("1000.0000"), "lcscs" );
   BOOST_REQUIRE_EQUAL( success(), stake( "alice1111111", "alice1111111", core_sym::from_string("200.0000"), core_sym::from_string("100.0000") ) );
   //now alice's stake should be equal to transfered from lcscs + own stake
   total = get_total_stake("alice1111111");
   BOOST_REQUIRE_EQUAL( core_sym::from_string("700.0000"), get_balance( "alice1111111" ) );
...
BOOST_FIXTURE_TEST_CASE( stake_to_self_with_transfer, lcscs_system_tester ) try {
   cross_15_percent_threshold();
...
BOOST_FIXTURE_TEST_CASE( stake_while_pending_refund, lcscs_system_tester ) try {
   cross_15_percent_threshold();
...
BOOST_FIXTURE_TEST_CASE( fail_without_auth, lcscs_system_tester ) try {
   cross_15_percent_threshold();

   issue_and_transfer( "alice1111111", core_sym::from_string("1000.0000"),  config::system_account_name );

   BOOST_REQUIRE_EQUAL( success(), stake( "lcscs", "alice1111111", core_sym::from_string("2000.0000"), core_sym::from_string("1000.0000") ) );
...
BOOST_FIXTURE_TEST_CASE( stake_negative, lcscs_system_tester ) try {
   issue_and_transfer( "alice1111111", core_sym::from_string("1000.0000"),  config::system_account_name );
...
BOOST_FIXTURE_TEST_CASE( unstake_negative, lcscs_system_tester ) try {
   issue_and_transfer( "alice1111111", core_sym::from_string("1000.0000"),  config::system_account_name );
...
BOOST_FIXTURE_TEST_CASE( unstake_more_than_at_stake, lcscs_system_tester ) try {
   cross_15_percent_threshold();
...
BOOST_FIXTURE_TEST_CASE( delegate_to_another_user, lcscs_system_tester ) try {
   cross_15_percent_threshold();
...
BOOST_FIXTURE_TEST_CASE( stake_unstake_separate, lcscs_system_tester ) try {
   cross_15_percent_threshold();
...
BOOST_FIXTURE_TEST_CASE( adding_stake_partial_unstake, lcscs_system_tester ) try {
   cross_15_percent_threshold();
...
BOOST_FIXTURE_TEST_CASE( stake_from_refund, lcscs_system_tester ) try {
   cross_15_percent_threshold();
...
BOOST_FIXTURE_TEST_CASE( stake_to_another_user_not_from_refund, lcscs_system_tester ) try {
   cross_15_percent_threshold();
...
// Tests for voting
BOOST_FIXTURE_TEST_CASE( producer_register_unregister, lcscs_system_tester ) try {
   issue_and_transfer( "alice1111111", core_sym::from_string("1000.0000"),  config::system_account_name );

   //fc::variant params = producer_parameters_example(1);
   auto key =  fc::crypto::public_key( std::string("scs6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV") );
   ...
   auto key2 =  fc::crypto::public_key( std::string("scs5jnmSKrzdBHE9n8hw58y7yxFWBC8SNiG7m8S1crJH3KvAnf9o6") );
   BOOST_REQUIRE_EQUAL( success(), push_action(N(alice1111111), N(regproducer), mvo()
                                               ("producer",  "alice1111111")
                                               ("producer_key", key2 )
                                               ("url", "http://block.two")
...
BOOST_FIXTURE_TEST_CASE( producer_wtmsig, lcscs_system_tester ) try {
   cross_15_percent_threshold();
...
BOOST_FIXTURE_TEST_CASE( producer_wtmsig_transition, lcscs_system_tester ) try {
   cross_15_percent_threshold();
   ...
   // authority which would be rejected by the lcscs native system and cause the onblock transaction to continue to fail.
...
BOOST_FIXTURE_TEST_CASE( vote_for_producer, lcscs_system_tester, * boost::unit_test::tolerance(1e+5) ) try {
   cross_15_percent_threshold();
   ...
   BOOST_REQUIRE_EQUAL( success(), unstake( "carol1111111", core_sym::from_string("2.0000"), core_sym::from_string("0.0002")/*"2.0000 scs", "0.0002 scs"*/ ) );
...
BOOST_FIXTURE_TEST_CASE( unregistered_producer_voting, lcscs_system_tester, * boost::unit_test::tolerance(1e+5) ) try {
   issue_and_transfer( "bob111111111", core_sym::from_string("2000.0000"),  config::system_account_name );
...
BOOST_FIXTURE_TEST_CASE( more_than_30_producer_voting, lcscs_system_tester ) try {
   issue_and_transfer( "bob111111111", core_sym::from_string("2000.0000"),  config::system_account_name );
   BOOST_REQUIRE_EQUAL( success(), stake( "bob111111111", core_sym::from_string("13.0000"), core_sym::from_string("0.5791") ) );
   REQUIRE_MATCHING_OBJECT( voter( "bob111111111", core_sym::from_string("13.5791") ), get_voter_info( "bob111111111" ) );
...
BOOST_FIXTURE_TEST_CASE( vote_same_producer_30_times, lcscs_system_tester ) try {
   issue_and_transfer( "bob111111111", core_sym::from_string("2000.0000"),  config::system_account_name );
...
BOOST_FIXTURE_TEST_CASE( producer_keep_votes, lcscs_system_tester, * boost::unit_test::tolerance(1e+5) ) try {
   issue_and_transfer( "alice1111111", core_sym::from_string("1000.0000"),  config::system_account_name );
   fc::variant params = producer_parameters_example(1);
...
BOOST_FIXTURE_TEST_CASE( vote_for_two_producers, lcscs_system_tester, * boost::unit_test::tolerance(1e+5) ) try {
   //alice1111111 becomes a producer
   fc::variant params = producer_parameters_example(1);
...
BOOST_FIXTURE_TEST_CASE( proxy_register_unregister_keeps_stake, lcscs_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( proxy_stake_unstake_keeps_proxy_flag, lcscs_system_tester ) try {
   cross_15_percent_threshold();
...
BOOST_FIXTURE_TEST_CASE( proxy_actions_affect_producers, lcscs_system_tester, * boost::unit_test::tolerance(1e+5) ) try {
   cross_15_percent_threshold();
...
BOOST_FIXTURE_TEST_CASE(producer_pay, lcscs_system_tester, * boost::unit_test::tolerance(1e-10)) try {
   ...
   // produce enough blocks so new schedule kicks in and defproducera produces some blocks
   {
      ...
      const int64_t  initial_savings           = get_balance(N(lcscs.saving)).get_amount();
      ...
      const int64_t  savings           = get_balance(N(lcscs.saving)).get_amount();
...
BOOST_FIXTURE_TEST_CASE(change_inflation, lcscs_system_tester) try {
...

   {
      ...
      auto run_for_1year = [this](int64_t annual_rate, int64_t inflation_pay_factor, int64_t votepay_factor) {
         ...
         const int64_t final_savings = get_balance(N(lcscs.saving)).get_amount();
...
BOOST_AUTO_TEST_CASE(extreme_inflation) try {
   lcscs_system_tester t(lcscs_system_tester::setup_level::minimal);
   symbol core_symbol{CORE_SYM};
   t.create_currency( N(lcscs.token), config::system_account_name, asset((1ll << 62) - 1, core_symbol) );
   ...
   {
      vector<char> data = t.get_row_by_account( N(lcscs.token), name(core_symbol.to_symbol_code().value), N(stat), account_name(core_symbol.to_symbol_code().value) );
      current_supply = t.token_abi_ser.binary_to_variant("currency_stats", data, lcscs_system_tester::abi_serializer_max_time)["supply"].template as<asset>();
   }
...
BOOST_FIXTURE_TEST_CASE(multiple_producer_pay, lcscs_system_tester, * boost::unit_test::tolerance(1e-10)) try {
...

   {
      ...
      const uint32_t initial_tot_unpaid_blocks = initial_global_state["total_unpaid_blocks"].as<uint32_t>();
      const asset    initial_supply            = get_token_supply();
      const asset    initial_bpay_balance      = get_balance(N(lcscs.bpay));
      const asset    initial_vpay_balance      = get_balance(N(lcscs.vpay));
      ...
      const uint32_t tot_unpaid_blocks = global_state["total_unpaid_blocks"].as<uint32_t>();
      const asset    supply            = get_token_supply();
      const asset    bpay_balance      = get_balance(N(lcscs.bpay));
      const asset    vpay_balance      = get_balance(N(lcscs.vpay));
...

   {
      ...
      BOOST_REQUIRE_EQUAL( error("missing authority of lcscs"),
...
BOOST_FIXTURE_TEST_CASE(multiple_producer_votepay_share, lcscs_system_tester, * boost::unit_test::tolerance(1e-10)) try {
...
BOOST_FIXTURE_TEST_CASE(votepay_share_invariant, lcscs_system_tester, * boost::unit_test::tolerance(1e-10)) try {
...
BOOST_FIXTURE_TEST_CASE(votepay_share_proxy, lcscs_system_tester, * boost::unit_test::tolerance(1e-5)) try {
...
BOOST_FIXTURE_TEST_CASE(votepay_share_update_order, lcscs_system_tester, * boost::unit_test::tolerance(1e-10)) try {
...
BOOST_FIXTURE_TEST_CASE(votepay_transition, lcscs_system_tester, * boost::unit_test::tolerance(1e-10)) try {
   ...
   auto* tbl = control->db().find<lcscs::chain::table_id_object, lcscs::chain::by_code_scope_table>(
   ...
   tbl = control->db().find<lcscs::chain::table_id_object, lcscs::chain::by_code_scope_table>(
                  boost::make_tuple( config::system_account_name,
                                     config::system_account_name,
                                     N(producers2) ) );
   BOOST_REQUIRE( !tbl );
...
BOOST_AUTO_TEST_CASE(votepay_transition2, * boost::unit_test::tolerance(1e-10)) try {
   ...
   symbol old_contract_core_symbol{::lcscs::chain::string_to_symbol_c( 4, old_contract_core_symbol_name.c_str() )};

   auto old_core_from_string = [&]( const std::string& s ) {
      return lcscs::chain::asset::from_string(s + " " + old_contract_core_symbol_name);
   };
   ...
   t.set_abi(  config::system_account_name, contracts::util::system_abi_old().data() );
   {
      ...
      t.abi_ser.set_abi(abi, lcscs_system_tester::abi_serializer_max_time);
   }
   ...
   auto* tbl = t.control->db().find<lcscs::chain::table_id_object, lcscs::chain::by_code_scope_table>(
                                    boost::make_tuple( config::system_account_name,
                                                       config::system_account_name,
                                                       N(producers2) ) );
   BOOST_REQUIRE( !tbl );
...
BOOST_FIXTURE_TEST_CASE(producers_upgrade_system_contract, lcscs_system_tester) try {
...
BOOST_FIXTURE_TEST_CASE(producer_onblock_check, lcscs_system_tester) try {
...
BOOST_FIXTURE_TEST_CASE( voters_actions_affect_proxy_and_producers, lcscs_system_tester, * boost::unit_test::tolerance(1e+6) ) try {
   cross_15_percent_threshold();
...
BOOST_FIXTURE_TEST_CASE( vote_both_proxy_and_producers, lcscs_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( select_invalid_proxy, lcscs_system_tester ) try {
   //accumulate proxied votes
   issue_and_transfer( "bob111111111", core_sym::from_string("1000.0000"),  config::system_account_name );
   BOOST_REQUIRE_EQUAL( success(), stake( "bob111111111", core_sym::from_string("100.0002"), core_sym::from_string("50.0001") ) );
...
BOOST_FIXTURE_TEST_CASE( double_register_unregister_proxy_keeps_votes, lcscs_system_tester ) try {
   //alice1111111 becomes a proxy
   BOOST_REQUIRE_EQUAL( success(), push_action( N(alice1111111), N(regproxy), mvo()
                                                ("proxy",  "alice1111111")
                                                ("isproxy",  1)
...
BOOST_FIXTURE_TEST_CASE( proxy_cannot_use_another_proxy, lcscs_system_tester ) try {
   //alice1111111 becomes a proxy
   BOOST_REQUIRE_EQUAL( success(), push_action( N(alice1111111), N(regproxy), mvo()
                                                ("proxy",  "alice1111111")
                                                ("isproxy",  1)
...
fc::mutable_variant_object config_to_variant( const lcscs::chain::chain_config& config ) {
...
BOOST_FIXTURE_TEST_CASE( elect_producers /*_and_parameters*/, lcscs_system_tester ) try {
   create_accounts_with_resources( {  N(defproducer1), N(defproducer2), N(defproducer3) } );
   BOOST_REQUIRE_EQUAL( success(), regproducer( N(defproducer1), 1) );
   BOOST_REQUIRE_EQUAL( success(), regproducer( N(defproducer2), 2) );
   BOOST_REQUIRE_EQUAL( success(), regproducer( N(defproducer3), 3) );
   ...
   transfer( "lcscs", "alice1111111", core_sym::from_string("600000000.0000"), "lcscs" );
...
BOOST_FIXTURE_TEST_CASE( buyname, lcscs_system_tester ) try {
   ...
   BOOST_REQUIRE_EXCEPTION( create_accounts_with_resources( { N(fail) }, N(dan) ), // dan shouldn't be able to create fail
                            lcscs_assert_message_exception, lcscs_assert_message_is( "no active bid for name" ) );
   ...
   BOOST_REQUIRE_EXCEPTION( create_accounts_with_resources( { N(nofail) }, N(dan) ), // dan shoudn't be able to do this, sam won
                            lcscs_assert_message_exception, lcscs_assert_message_is( "only highest bidder can claim" ) );
   ...
   transfer( "lcscs", "nofail", core_sym::from_string( "1000.0000" ) );
   ...
   BOOST_REQUIRE_EXCEPTION( create_accounts_with_resources( { N(test.fail) }, N(dan) ), // dan shouldn't be able to do this
                            lcscs_assert_message_exception, lcscs_assert_message_is( "only suffix may create this account" ) );

   create_accounts_with_resources( { N(goodgoodgood) }, N(dan) ); /// 12 char names should succeed
} FC_LOG_AND_RETHROW()

BOOST_FIXTURE_TEST_CASE( bid_invalid_names, lcscs_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( multiple_namebids, lcscs_system_tester ) try {
   ...
   {
      const asset initial_names_balance = get_balance(N(lcscs.names));
      BOOST_REQUIRE_EQUAL( success(),
      ...
      BOOST_REQUIRE_EQUAL( initial_names_balance + core_sym::from_string("0.1001"), get_balance(N(lcscs.names)) );
   }
...
BOOST_FIXTURE_TEST_CASE( namebid_pending_winner, lcscs_system_tester ) try {
   cross_15_percent_threshold();
...
BOOST_FIXTURE_TEST_CASE( vote_producers_in_and_out, lcscs_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( setparams, lcscs_system_tester ) try {
   //install multisig contract
   abi_serializer msig_abi_ser = initialize_multisig();
   auto producer_names = active_and_vote_producers();
   ...
   lcscs::chain::chain_config params;
...
BOOST_FIXTURE_TEST_CASE( setram_effect, lcscs_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( ram_inflation, lcscs_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( lcscsram_ramusage, lcscs_system_tester ) try {
   BOOST_REQUIRE_EQUAL( core_sym::from_string("0.0000"), get_balance( "alice1111111" ) );
   transfer( "lcscs", "alice1111111", core_sym::from_string("1000.0000"), "lcscs" );
   BOOST_REQUIRE_EQUAL( success(), stake( "lcscs", "alice1111111", core_sym::from_string("200.0000"), core_sym::from_string("100.0000") ) );
   ...
   BOOST_REQUIRE_EQUAL( false, get_row_by_account( N(lcscs.token), N(alice1111111), N(accounts), account_name(symbol{CORE_SYM}.to_symbol_code()) ).empty() );

   //remove row
   base_tester::push_action( N(lcscs.token), N(close), N(alice1111111), mvo()
                             ( "owner", "alice1111111" )
                             ( "symbol", symbol{CORE_SYM} )
   );
   BOOST_REQUIRE_EQUAL( true, get_row_by_account( N(lcscs.token), N(alice1111111), N(accounts), account_name(symbol{CORE_SYM}.to_symbol_code()) ).empty() );

   auto rlm = control->get_resource_limits_manager();
   auto lcscsram_ram_usage = rlm.get_account_ram_usage(N(lcscs.ram));
   auto alice_ram_usage = rlm.get_account_ram_usage(N(alice1111111));

   BOOST_REQUIRE_EQUAL( success(), sellram( "alice1111111", 2048 ) );

   //make sure that ram was billed to alice, not to lcscs.ram
   BOOST_REQUIRE_EQUAL( true, alice_ram_usage < rlm.get_account_ram_usage(N(alice1111111)) );
   BOOST_REQUIRE_EQUAL( lcscsram_ram_usage, rlm.get_account_ram_usage(N(lcscs.ram)) );

} FC_LOG_AND_RETHROW()

BOOST_FIXTURE_TEST_CASE( ram_gift, lcscs_system_tester ) try {
   ...
   */
   ...
   BOOST_REQUIRE_EQUAL( success(), unstake( "lcscs", "alice1111111", core_sym::from_string("20.0000"), core_sym::from_string("10.0000") ) );
...
BOOST_FIXTURE_TEST_CASE( rex_auth, lcscs_system_tester ) try {
   ...
   const asset one_scs      = core_sym::from_string("1.0000");
   ...
   BOOST_REQUIRE_EQUAL( error(error_msg), push_action( bob, N(deposit), mvo()("owner", alice)("amount", one_scs) ) );
   BOOST_REQUIRE_EQUAL( error(error_msg), push_action( bob, N(withdraw), mvo()("owner", alice)("amount", one_scs) ) );
   BOOST_REQUIRE_EQUAL( error(error_msg), push_action( bob, N(buyrex), mvo()("from", alice)("amount", one_scs) ) );
   BOOST_REQUIRE_EQUAL( error(error_msg),
                        push_action( bob, N(unstaketorex), mvo()("owner", alice)("receiver", alice)("from_net", one_scs)("from_cpu", one_scs) ) );
   ...
   BOOST_REQUIRE_EQUAL( error(error_msg),
                        push_action( bob, N(rentcpu), mvo()("from", alice)("receiver", alice)("loan_payment", one_scs)("loan_fund", one_scs) ) );
   BOOST_REQUIRE_EQUAL( error(error_msg),
                        push_action( bob, N(rentnet), mvo()("from", alice)("receiver", alice)("loan_payment", one_scs)("loan_fund", one_scs) ) );
   BOOST_REQUIRE_EQUAL( error(error_msg), push_action( bob, N(fundcpuloan), mvo()("from", alice)("loan_num", 1)("payment", one_scs) ) );
   BOOST_REQUIRE_EQUAL( error(error_msg), push_action( bob, N(fundnetloan), mvo()("from", alice)("loan_num", 1)("payment", one_scs) ) );
   BOOST_REQUIRE_EQUAL( error(error_msg), push_action( bob, N(defcpuloan), mvo()("from", alice)("loan_num", 1)("amount", one_scs) ) );
   BOOST_REQUIRE_EQUAL( error(error_msg), push_action( bob, N(defnetloan), mvo()("from", alice)("loan_num", 1)("amount", one_scs) ) );
   ...
   BOOST_REQUIRE_EQUAL( error("missing authority of lcscs"), push_action( alice, N(setrex), mvo()("balance", one_scs) ) );

} FC_LOG_AND_RETHROW()


BOOST_FIXTURE_TEST_CASE( buy_sell_rex, lcscs_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( buy_sell_small_rex, lcscs_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( unstake_buy_rex, lcscs_system_tester, * boost::unit_test::tolerance(1e-10) ) try {
...

   {
      ...
      const asset init_lcscs_stake_balance = get_balance( N(lcscs.stake) );
      ...
      BOOST_REQUIRE_EQUAL( tot_stake,                               get_balance( N(lcscs.rex) ) );
      BOOST_REQUIRE_EQUAL( tot_stake,                               init_lcscs_stake_balance - get_balance( N(lcscs.stake) ) );
...
BOOST_FIXTURE_TEST_CASE( buy_rent_rex, lcscs_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( buy_sell_sell_rex, lcscs_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( buy_sell_claim_rex, lcscs_system_tester ) try {
   ...
   const int64_t init_alice_rex_stake = ( lcscs::chain::uint128_t(init_alice_rex.get_amount()) * total_lendable ) / total_rex;
...
BOOST_FIXTURE_TEST_CASE( rex_loans, lcscs_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( rex_loan_checks, lcscs_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( ramfee_namebid_to_rex, lcscs_system_tester ) try {
   ...
   asset cur_ramfee_balance = get_balance( N(lcscs.ramfee) );
   BOOST_REQUIRE_EQUAL( success(),                      buyram( alice, alice, core_sym::from_string("20.0000") ) );
   BOOST_REQUIRE_EQUAL( get_balance( N(lcscs.ramfee) ), core_sym::from_string("0.1000") + cur_ramfee_balance );
   ...
   cur_ramfee_balance = get_balance( N(lcscs.ramfee) );
   asset cur_rex_balance = get_balance( N(lcscs.rex) );
   ...
   BOOST_REQUIRE_EQUAL( cur_ramfee_balance,                get_balance( N(lcscs.ramfee) ) );
   BOOST_REQUIRE_EQUAL( get_balance( N(lcscs.rex) ),       cur_rex_balance + core_sym::from_string("0.3500") );

   cur_rex_balance = get_balance( N(lcscs.rex) );
   ...
   BOOST_REQUIRE_EQUAL( core_sym::from_string("23.7000"), get_balance( N(lcscs.names) ) );
   BOOST_REQUIRE_EQUAL( success(),                        bidname( alice, N(rndmbid), core_sym::from_string("29.3500") ) );
   BOOST_REQUIRE_EQUAL( core_sym::from_string("29.3500"), get_balance( N(lcscs.names) ));
   ...
   BOOST_REQUIRE_EQUAL( get_balance( N(lcscs.rex) ),      cur_rex_balance + core_sym::from_string("34.3500") );
   BOOST_REQUIRE_EQUAL( 0,                                get_balance( N(lcscs.names) ).get_amount() );
...
BOOST_FIXTURE_TEST_CASE( rex_maturity, lcscs_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( rex_savings, lcscs_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( update_rex, lcscs_system_tester, * boost::unit_test::tolerance(1e-10) ) try {
   ...
   const int64_t init_alice_rex_stake = ( lcscs::chain::uint128_t(init_rex.get_amount()) * total_lendable ) / total_rex;
...
BOOST_FIXTURE_TEST_CASE( update_rex_vote, lcscs_system_tester, * boost::unit_test::tolerance(1e-8) ) try {
...
BOOST_FIXTURE_TEST_CASE( deposit_rex_fund, lcscs_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( rex_lower_bound, lcscs_system_tester ) try {
   ...
   double rex_per_scs = double(tot_rex) / double(tot_lendable);
   int64_t sell_amount = rex_per_scs * ( tot_unlent - 0.09 * tot_lent );
   produce_block( fc::days(5) );
   BOOST_REQUIRE_EQUAL( success(), sellrex( alice, asset( sell_amount, rex_sym ) ) );
   BOOST_REQUIRE_EQUAL( success(), cancelrexorder( alice ) );
   sell_amount = rex_per_scs * ( tot_unlent - 0.1 * tot_lent );
   BOOST_REQUIRE_EQUAL( success(), sellrex( alice, asset( sell_amount, rex_sym ) ) );
...
BOOST_FIXTURE_TEST_CASE( close_rex, lcscs_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( set_rex, lcscs_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( b1_vesting, lcscs_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( rex_return, lcscs_system_tester ) try {
...
BOOST_AUTO_TEST_CASE( setabi_bios ) try {
   ...
   t.create_account(N(lcscs.token));
   t.set_abi( N(lcscs.token), contracts::token_abi().data() );
   {
      auto res = t.get_row_by_account( config::system_account_name, config::system_account_name, N(abihash), N(lcscs.token) );
      _abi_hash abi_hash;
   ...
   t.set_abi( N(lcscs.token), contracts::system_abi().data() );
   {
      auto res = t.get_row_by_account( config::system_account_name, config::system_account_name, N(abihash), N(lcscs.token) );
      _abi_hash abi_hash;
      auto abi_hash_var = abi_ser.binary_to_variant( "abi_hash", res, base_tester::abi_serializer_max_time );
...
BOOST_FIXTURE_TEST_CASE( setabi, lcscs_system_tester ) try {
   set_abi( N(lcscs.token), contracts::token_abi().data() );
   {
      auto res = get_row_by_account( config::system_account_name, config::system_account_name, N(abihash), N(lcscs.token) );
      _abi_hash abi_hash;
   ...
   set_abi( N(lcscs.token), contracts::system_abi().data() );
   {
      auto res = get_row_by_account( config::system_account_name, config::system_account_name, N(abihash), N(lcscs.token) );
      _abi_hash abi_hash;
      auto abi_hash_var = abi_ser.binary_to_variant( "abi_hash", res, abi_serializer_max_time );
...
BOOST_FIXTURE_TEST_CASE( change_limited_account_back_to_unlimited, lcscs_system_tester ) try {
   BOOST_REQUIRE( get_total_stake( "lcscs" ).is_null() );

   transfer( N(lcscs), N(alice1111111), core_sym::from_string("1.0000") );

   auto error_msg = stake( N(alice1111111), N(lcscs), core_sym::from_string("0.0000"), core_sym::from_string("1.0000") );
   auto semicolon_pos = error_msg.find(';');

   BOOST_REQUIRE_EQUAL( error("account lcscs has insufficient ram"),
   ...
   push_action( N(lcscs), N(setalimits), mvo()
                                          ("account", "lcscs")
   ...
   stake( N(alice1111111), N(lcscs), core_sym::from_string("0.0000"), core_sym::from_string("1.0000") );

   REQUIRE_MATCHING_OBJECT( get_total_stake( "lcscs" ), mvo()
      ("owner", "lcscs")
   ...
   BOOST_REQUIRE_EQUAL( success(),
                        push_action( N(lcscs), N(setacctnet), mvo()
                           ("account", "lcscs")
                           ("net_weight", -1)
                        )
   );
   ...
   BOOST_REQUIRE_EQUAL( success(),
                        push_action( N(lcscs), N(setacctcpu), mvo()
                           ("account", "lcscs")
                           ("cpu_weight", -1)
...
BOOST_FIXTURE_TEST_CASE( buy_pin_sell_ram, lcscs_system_tester ) try {
   BOOST_REQUIRE( get_total_stake( "lcscs" ).is_null() );

   transfer( N(lcscs), N(alice1111111), core_sym::from_string("1020.0000") );

   auto error_msg = stake( N(alice1111111), N(lcscs), core_sym::from_string("10.0000"), core_sym::from_string("10.0000") );
   auto semicolon_pos = error_msg.find(';');
   ...
   BOOST_REQUIRE_EQUAL( success(), buyrambytes( N(alice1111111), N(lcscs), static_cast<uint32_t>(ram_bytes_needed) ) );

   auto tokens_paid_for_ram = alice_original_balance - get_balance( N(alice1111111) );

   auto total_res = get_total_stake( "lcscs" );
   ...
   BOOST_REQUIRE_EQUAL( success(),
                        push_action( N(lcscs), N(setacctram), mvo()
                           ("account", "lcscs")
                           ("ram_bytes", total_res["ram_bytes"].as_int64() )
                        )
   );

   auto lcscs_original_balance = get_balance( N(lcscs) );

   BOOST_REQUIRE_EQUAL( success(), sellram( N(lcscs), total_res["ram_bytes"].as_int64() ) );

   auto tokens_received_by_selling_ram = get_balance( N(lcscs) ) - lcscs_original_balance;
