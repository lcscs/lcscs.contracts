...
namespace lcscs {
   ...
   /**
    * @defgroup lcscsmsig lcscs.msig
    * @ingroup lcscscontracts
    * lcscs.msig contract defines the structures and actions needed to manage the proposals and approvals on blockchain.
    * @{
    */
   class [[lcscs::contract("lcscs.msig")]] multisig : public contract {
      public:
         ...
         void approve( name proposer, name proposal_name, permission_level level,
                       const lcscs::binary_extension<lcscs::checksum256>& proposal_hash );
         /**
         ...
         using propose_action = lcscs::action_wrapper<"propose"_n, &multisig::propose>;
         using approve_action = lcscs::action_wrapper<"approve"_n, &multisig::approve>;
         using unapprove_action = lcscs::action_wrapper<"unapprove"_n, &multisig::unapprove>;
         using cancel_action = lcscs::action_wrapper<"cancel"_n, &multisig::cancel>;
         using exec_action = lcscs::action_wrapper<"exec"_n, &multisig::exec>;
         using invalidate_action = lcscs::action_wrapper<"invalidate"_n, &multisig::invalidate>;

      private:
         struct [[lcscs::table]] proposal {
            name                            proposal_name;
         ...
         typedef lcscs::multi_index< "proposal"_n, proposal > proposals;

         struct [[lcscs::table]] old_approvals_info {
            name                            proposal_name;
         ...
         typedef lcscs::multi_index< "approvals"_n, old_approvals_info > old_approvals;
         ...
         struct [[lcscs::table]] approvals_info {
            uint8_t                 version = 1;
            name                    proposal_name;
         ...
         typedef lcscs::multi_index< "approvals2"_n, approvals_info > approvals;

         struct [[lcscs::table]] invalidation {
            name         account;
         ...
         typedef lcscs::multi_index< "invals"_n, invalidation > invalidations;
   };
   /** @}*/ // end of @defgroup lcscsmsig lcscs.msig
} /// namespace lcscs
