 ...
 * lcscs Contracts
 *
 * The design of the lcscs blockchain calls for a number of smart contracts that are run at a
 ...
 * managing, and/or using an lcscs blockchain. They are provided for reference purposes:
 * - lcscs.bios
 * - lcscs.system
 * - lcscs.msig
 * - lcscs.wrap
...
namespace lcscsbios {
   ...
   class [[lcscs::contract("lcscs.bios")]] bios : public lcscs::contract {
      public:
          ...
          */
         [[lcscs::action]]
         void setprods( const std::vector<lcscs::producer_authority>& schedule );
          ...
          */
         [[lcscs::action]]
         void reqactivated( const lcscs::checksum256& feature_digest );

         struct [[lcscs::table]] abi_hash {
            name              owner;
            checksum256       hash;
         ...
         typedef lcscs::multi_index< "abihash"_n, abi_hash > abi_hash_table;
