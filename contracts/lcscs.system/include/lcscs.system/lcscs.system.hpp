...
#include <lcscs/binary_extension.hpp>
#include <lcscs/privileged.hpp>
#include <lcscs/producer_schedule.hpp>
#include <lcscs/singleton.hpp>
#include <lcscs/system.hpp>
#include <lcscs/time.hpp>

#include <lcscs.system/exchange_state.hpp>
...
namespace lcscssystem {
   ...
   using lcscs::asset;
   using lcscs::block_timestamp;
   using lcscs::check;
   using lcscs::const_mem_fun;
   using lcscs::datastream;
   using lcscs::indexed_by;
   using lcscs::name;
   using lcscs::same_payer;
   using lcscs::symbol;
   using lcscs::symbol_code;
   using lcscs::time_point;
   using lcscs::time_point_sec;
   ...
   static constexpr int64_t  min_activated_stake   = 120'000'000'0000;
   static constexpr int64_t  ram_gift_bytes        = 1400;
   static constexpr int64_t  min_pervote_daily_pay = 100'0000;
   static constexpr uint32_t refund_delay_sec      = 3 * seconds_per_day;

   static constexpr uint32_t max_producers         = 15;              // the number of block producer, default is 15
   ...
   /**
    * lcscs.system contract
    * 
    * lcscs.system contract defines the structures and actions needed for blockchain's core functionality.
   ...
   struct [[lcscs::table, lcscs::contract("lcscs.system")]] name_bid {
     name            newname;
     name            high_bidder;
   ...
   struct [[lcscs::table, lcscs::contract("lcscs.system")]] bid_refund {
      name         bidder;
      asset        amount;

      uint64_t primary_key()const { return bidder.value; }
   };
   typedef lcscs::multi_index< "namebids"_n, name_bid,
                               indexed_by<"highbid"_n, const_mem_fun<name_bid, uint64_t, &name_bid::by_high_bid>  >
                             > name_bid_table;

   typedef lcscs::multi_index< "bidrefunds"_n, bid_refund > bid_refund_table;

   // Defines new global state parameters.
   struct [[lcscs::table("global"), lcscs::contract("lcscs.system")]] lcscs_global_state : lcscs::blockchain_parameters {
      ...
      scsLIB_SERIALIZE_DERIVED( lcscs_global_state, lcscs::blockchain_parameters,
   ...
   struct [[lcscs::table("global2"), lcscs::contract("lcscs.system")]] lcscs_global_state2 {
      lcscs_global_state2(){}
      ...
      scsLIB_SERIALIZE( lcscs_global_state2, (new_ram_per_block)(last_ram_increase)(last_block_num)
                        (total_producer_votepay_share)(revision) )
   };

   // Defines new global state parameters added after version 1.3.0
   struct [[lcscs::table("global3"), lcscs::contract("lcscs.system")]] lcscs_global_state3 {
      lcscs_global_state3() { }
      time_point        last_vpay_state_update;
      double            total_vpay_share_change_rate = 0;

      scsLIB_SERIALIZE( lcscs_global_state3, (last_vpay_state_update)(total_vpay_share_change_rate) )
   };

   // Defines new global state parameters to store inflation rate and distribution
   struct [[lcscs::table("global4"), lcscs::contract("lcscs.system")]] lcscs_global_state4 {
      lcscs_global_state4() { }
      double   continuous_rate;
      int64_t  inflation_pay_factor;
      int64_t  votepay_factor;

      scsLIB_SERIALIZE( lcscs_global_state4, (continuous_rate)(inflation_pay_factor)(votepay_factor) )
   };

   inline lcscs::block_signing_authority convert_to_block_signing_authority( const lcscs::public_key& producer_key ) {
      return lcscs::block_signing_authority_v0{ .threshold = 1, .keys = {{producer_key, 1}} };
   }

   // Defines `producer_info` structure to be stored in `producer_info` table, added after version 1.0
   struct [[lcscs::table, lcscs::contract("lcscs.system")]] producer_info {
      name                                                     owner;
      double                                                   total_votes = 0;
      lcscs::public_key                                        producer_key; /// a packed public key object
      bool                                                     is_active = true;
      std::string                                              url;
      uint32_t                                                 unpaid_blocks = 0;
      time_point                                               last_claim_time;
      uint16_t                                                 location = 0;
      lcscs::binary_extension<lcscs::block_signing_authority>  producer_authority; // added in version 1.9.0
      ...
      lcscs::block_signing_authority get_producer_authority()const {
         if( producer_authority.has_value() ) {
            bool zero_threshold = std::visit( [](auto&& auth ) -> bool {
               return (auth.threshold == 0);
            }, *producer_authority );
            // zero_threshold could be true despite the validation done in regproducer2 because the v1.9.0 lcscs.system
            // contract has a bug which may have modified the producer table such that the producer_authority field
            // contains a default constructed lcscs::block_signing_authority (which has a 0 threshold and so is invalid).
   ...
   struct [[lcscs::table, lcscs::contract("lcscs.system")]] producer_info2 {
      name            owner;
      ...
      // explicit serialization macro is not necessary, used here only to improve compilation time
      scsLIB_SERIALIZE( producer_info2, (owner)(votepay_share)(last_votepay_share_update) )
   };
   ...
   struct [[lcscs::table, lcscs::contract("lcscs.system")]] voter_info {
      ...
      // explicit serialization macro is not necessary, used here only to improve compilation time
      scsLIB_SERIALIZE( voter_info, (owner)(proxy)(producers)(staked)(last_vote_weight)(proxied_vote_weight)(is_proxy)(flags1)(reserved2)(reserved3) )
   };


   typedef lcscs::multi_index< "voters"_n, voter_info >  voters_table;


   typedef lcscs::multi_index< "producers"_n, producer_info,
                               indexed_by<"prototalvote"_n, const_mem_fun<producer_info, double, &producer_info::by_votes>  >
                             > producers_table;

   typedef lcscs::multi_index< "producers2"_n, producer_info2 > producers_table2;


   typedef lcscs::singleton< "global"_n, lcscs_global_state >   global_state_singleton;

   typedef lcscs::singleton< "global2"_n, lcscs_global_state2 > global_state2_singleton;

   typedef lcscs::singleton< "global3"_n, lcscs_global_state3 > global_state3_singleton;

   typedef lcscs::singleton< "global4"_n, lcscs_global_state4 > global_state4_singleton;

   struct [[lcscs::table, lcscs::contract("lcscs.system")]] user_resources {
      name          owner;
      asset         net_weight;
      asset         cpu_weight;
      int64_t       ram_bytes = 0;
      ...
      // explicit serialization macro is not necessary, used here only to improve compilation time
      scsLIB_SERIALIZE( user_resources, (owner)(net_weight)(cpu_weight)(ram_bytes) )
   };

   // Every user 'from' has a scope/table that uses every receipient 'to' as the primary key.
   struct [[lcscs::table, lcscs::contract("lcscs.system")]] delegated_bandwidth {
      name          from;
      name          to;
      asset         net_weight;
      asset         cpu_weight;
      ...
      // explicit serialization macro is not necessary, used here only to improve compilation time
      scsLIB_SERIALIZE( delegated_bandwidth, (from)(to)(net_weight)(cpu_weight) )

   };

   struct [[lcscs::table, lcscs::contract("lcscs.system")]] refund_request {
      name            owner;
      time_point_sec  request_time;
      lcscs::asset    net_amount;
      lcscs::asset    cpu_amount;

      bool is_empty()const { return net_amount.amount == 0 && cpu_amount.amount == 0; }
      uint64_t  primary_key()const { return owner.value; }

      // explicit serialization macro is not necessary, used here only to improve compilation time
      scsLIB_SERIALIZE( refund_request, (owner)(request_time)(net_amount)(cpu_amount) )
   };


   typedef lcscs::multi_index< "userres"_n, user_resources >      user_resources_table;
   typedef lcscs::multi_index< "delband"_n, delegated_bandwidth > del_bandwidth_table;
   typedef lcscs::multi_index< "refunds"_n, refund_request >      refunds_table;
   ...
   struct [[lcscs::table,lcscs::contract("lcscs.system")]] rex_pool {
      uint8_t    version = 0;
      asset      total_lent;
      asset      total_unlent;
      asset      total_rent;
   ...
   typedef lcscs::multi_index< "rexpool"_n, rex_pool > rex_pool_table;
   ...
   struct [[lcscs::table,lcscs::contract("lcscs.system")]] rex_return_pool {
      uint8_t        version = 0;
   ...
   typedef lcscs::multi_index< "rexretpool"_n, rex_return_pool > rex_return_pool_table;
   ...
   struct [[lcscs::table,lcscs::contract("lcscs.system")]] rex_return_buckets {
      uint8_t                           version = 0;
   ...
   typedef lcscs::multi_index< "retbuckets"_n, rex_return_buckets > rex_return_buckets_table;
   ...
   struct [[lcscs::table,lcscs::contract("lcscs.system")]] rex_fund {
      uint8_t version = 0;
      name    owner;
      asset   balance;
   ...
   typedef lcscs::multi_index< "rexfund"_n, rex_fund > rex_fund_table;
   ...
   struct [[lcscs::table,lcscs::contract("lcscs.system")]] rex_balance {
      uint8_t version = 0;
      name    owner;
      asset   vote_stake;
      asset   rex_balance;
   ...
   typedef lcscs::multi_index< "rexbal"_n, rex_balance > rex_balance_table;
   ...
   struct [[lcscs::table,lcscs::contract("lcscs.system")]] rex_loan {
      uint8_t             version = 0;
      name                from;
      name                receiver;
      asset               payment;
   ...
   typedef lcscs::multi_index< "cpuloan"_n, rex_loan,
   ...
   typedef lcscs::multi_index< "netloan"_n, rex_loan,
                               indexed_by<"byexpr"_n,  const_mem_fun<rex_loan, uint64_t, &rex_loan::by_expr>>,
                               indexed_by<"byowner"_n, const_mem_fun<rex_loan, uint64_t, &rex_loan::by_owner>>
                             > rex_net_loan_table;

   struct [[lcscs::table,lcscs::contract("lcscs.system")]] rex_order {
      uint8_t             version = 0;
      name                owner;
      asset               rex_requested;
      asset               proceeds;
      asset               stake_change;
      lcscs::time_point   order_time;
      bool                is_open = true;
   ...
   typedef lcscs::multi_index< "rexqueue"_n, rex_order,
   ...
   /**
    * The lcscs system contract. The lcscs system contract governs ram market, voters, producers, global state.
    */
   class [[lcscs::contract("lcscs.system")]] system_contract : public native {
      ...
      private:
         ...
         lcscs_global_state       _gstate;
         lcscs_global_state2      _gstate2;
         lcscs_global_state3      _gstate3;
         lcscs_global_state4      _gstate4;
      ...
      public:
         static constexpr lcscs::name active_permission{"active"_n};
         static constexpr lcscs::name token_account{"scs.token"_n};
         static constexpr lcscs::name ram_account{"scs.ram"_n};
         static constexpr lcscs::name ramfee_account{"scs.ramfee"_n};
         static constexpr lcscs::name stake_account{"scs.stake"_n};
         static constexpr lcscs::name bpay_account{"scs.bpay"_n};
         static constexpr lcscs::name vpay_account{"scs.vpay"_n};
         static constexpr lcscs::name names_account{"scs.names"_n};
         static constexpr lcscs::name saving_account{"scs.saving"_n};
         static constexpr lcscs::name rex_account{"scs.rex"_n};
         static constexpr lcscs::name null_account{"scs.null"_n};
         ...
         static symbol get_core_symbol( name system_account = "lcscs"_n ) {
          ...
          */
         [[lcscs::action]]
         void activate( const lcscs::checksum256& feature_digest );
          ...
          */
         [[lcscs::action]]
         void regproducer2( const name& producer, const lcscs::block_signing_authority& producer_authority, const std::string& url, uint16_t location );
          ...
          * @pre Voter must have previously staked some scs for voting
          ...
          */
         [[lcscs::action]]
         void setparams( const lcscs::blockchain_parameters& params );
          ...
          *     The remaining inflation will be sent to the `lcscs.saving` account.
         ...
         using init_action = lcscs::action_wrapper<"init"_n, &system_contract::init>;
         using setacctram_action = lcscs::action_wrapper<"setacctram"_n, &system_contract::setacctram>;
         using setacctnet_action = lcscs::action_wrapper<"setacctnet"_n, &system_contract::setacctnet>;
         using setacctcpu_action = lcscs::action_wrapper<"setacctcpu"_n, &system_contract::setacctcpu>;
         using activate_action = lcscs::action_wrapper<"activate"_n, &system_contract::activate>;
         using delegatebw_action = lcscs::action_wrapper<"delegatebw"_n, &system_contract::delegatebw>;
         using deposit_action = lcscs::action_wrapper<"deposit"_n, &system_contract::deposit>;
         using withdraw_action = lcscs::action_wrapper<"withdraw"_n, &system_contract::withdraw>;
         using buyrex_action = lcscs::action_wrapper<"buyrex"_n, &system_contract::buyrex>;
         using unstaketorex_action = lcscs::action_wrapper<"unstaketorex"_n, &system_contract::unstaketorex>;
         using sellrex_action = lcscs::action_wrapper<"sellrex"_n, &system_contract::sellrex>;
         using cnclrexorder_action = lcscs::action_wrapper<"cnclrexorder"_n, &system_contract::cnclrexorder>;
         using rentcpu_action = lcscs::action_wrapper<"rentcpu"_n, &system_contract::rentcpu>;
         using rentnet_action = lcscs::action_wrapper<"rentnet"_n, &system_contract::rentnet>;
         using fundcpuloan_action = lcscs::action_wrapper<"fundcpuloan"_n, &system_contract::fundcpuloan>;
         using fundnetloan_action = lcscs::action_wrapper<"fundnetloan"_n, &system_contract::fundnetloan>;
         using defcpuloan_action = lcscs::action_wrapper<"defcpuloan"_n, &system_contract::defcpuloan>;
         using defnetloan_action = lcscs::action_wrapper<"defnetloan"_n, &system_contract::defnetloan>;
         using updaterex_action = lcscs::action_wrapper<"updaterex"_n, &system_contract::updaterex>;
         using rexexec_action = lcscs::action_wrapper<"rexexec"_n, &system_contract::rexexec>;
         using setrex_action = lcscs::action_wrapper<"setrex"_n, &system_contract::setrex>;
         using mvtosavings_action = lcscs::action_wrapper<"mvtosavings"_n, &system_contract::mvtosavings>;
         using mvfrsavings_action = lcscs::action_wrapper<"mvfrsavings"_n, &system_contract::mvfrsavings>;
         using consolidate_action = lcscs::action_wrapper<"consolidate"_n, &system_contract::consolidate>;
         using closerex_action = lcscs::action_wrapper<"closerex"_n, &system_contract::closerex>;
         using undelegatebw_action = lcscs::action_wrapper<"undelegatebw"_n, &system_contract::undelegatebw>;
         using buyram_action = lcscs::action_wrapper<"buyram"_n, &system_contract::buyram>;
         using buyrambytes_action = lcscs::action_wrapper<"buyrambytes"_n, &system_contract::buyrambytes>;
         using sellram_action = lcscs::action_wrapper<"sellram"_n, &system_contract::sellram>;
         using refund_action = lcscs::action_wrapper<"refund"_n, &system_contract::refund>;
         using regproducer_action = lcscs::action_wrapper<"regproducer"_n, &system_contract::regproducer>;
         using regproducer2_action = lcscs::action_wrapper<"regproducer2"_n, &system_contract::regproducer2>;
         using unregprod_action = lcscs::action_wrapper<"unregprod"_n, &system_contract::unregprod>;
         using setram_action = lcscs::action_wrapper<"setram"_n, &system_contract::setram>;
         using setramrate_action = lcscs::action_wrapper<"setramrate"_n, &system_contract::setramrate>;
         using voteproducer_action = lcscs::action_wrapper<"voteproducer"_n, &system_contract::voteproducer>;
         using regproxy_action = lcscs::action_wrapper<"regproxy"_n, &system_contract::regproxy>;
         using claimrewards_action = lcscs::action_wrapper<"claimrewards"_n, &system_contract::claimrewards>;
         using rmvproducer_action = lcscs::action_wrapper<"rmvproducer"_n, &system_contract::rmvproducer>;
         using updtrevision_action = lcscs::action_wrapper<"updtrevision"_n, &system_contract::updtrevision>;
         using bidname_action = lcscs::action_wrapper<"bidname"_n, &system_contract::bidname>;
         using bidrefund_action = lcscs::action_wrapper<"bidrefund"_n, &system_contract::bidrefund>;
         using setpriv_action = lcscs::action_wrapper<"setpriv"_n, &system_contract::setpriv>;
         using setalimits_action = lcscs::action_wrapper<"setalimits"_n, &system_contract::setalimits>;
         using setparams_action = lcscs::action_wrapper<"setparams"_n, &system_contract::setparams>;
         using setinflation_action = lcscs::action_wrapper<"setinflation"_n, &system_contract::setinflation>;
      ...
      private:
         ...
         //defined in lcscs.system.cpp
         static lcscs_global_state get_default_parameters();
         static lcscs_global_state4 get_default_inflation_parameters();
         ...
         void register_producer( const name& producer, const lcscs::block_signing_authority& producer_authority, const std::string& url, uint16_t location );
