...
namespace lcscssystem {
    ...
    */
   struct [[lcscs::table, lcscs::contract("lcscs.system")]] exchange_state {
      asset    supply;
      ...
      struct connector {
         ...
         scsLIB_SERIALIZE( connector, (balance)(weight) )
      };
      ...
      scsLIB_SERIALIZE( exchange_state, (supply)(base)(quote) )
   };

   typedef lcscs::multi_index< "rammarket"_n, exchange_state > rammarket;
   /** @}*/ // enf of @addtogroup lcscssystem
} /// namespace lcscssystem
