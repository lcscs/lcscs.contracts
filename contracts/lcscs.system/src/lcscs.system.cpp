...
namespace lcscssystem {
    ...
    _rexorders(get_self(), get_self().value)
   {
      ...
      _gstate2 = _global2.exists() ? _global2.get() : lcscs_global_state2{};
      _gstate3 = _global3.exists() ? _global3.get() : lcscs_global_state3{};
      _gstate4 = _global4.exists() ? _global4.get() : get_default_inflation_parameters();
   }

   lcscs_global_state system_contract::get_default_parameters() {
      lcscs_global_state dp;
      get_blockchain_parameters(dp);
      return dp;
   }

   lcscs_global_state4 system_contract::get_default_inflation_parameters() {
      lcscs_global_state4 gs4;
   ...
   void system_contract::update_ram_supply() {
      auto cbt = lcscs::current_block_time();
   ...
   void system_contract::setparams( const lcscs::blockchain_parameters& params ) {
      require_auth( get_self() );
      (lcscs::blockchain_parameters&)(_gstate) = params;
   ...
   void system_contract::activate( const lcscs::checksum256& feature_digest ) {
      require_auth( get_self() );
   ...
   void native::setabi( const name& acnt, const std::vector<char>& abi ) {
      lcscs::multi_index< "abihash"_n, abi_hash >  table(get_self(), get_self().value);
   ...
   void system_contract::init( unsigned_int version, const symbol& core ) {
      ...
      auto system_token_supply   = lcscs::token::get_supply(token_account, core.code() );
